...
class Projeto(models.Model):
	...
	ciclo_vida = models.ForeignKey(CicloVida, verbose_name="Ciclo de Vida", on_delete=models.CASCADE, default=False, blank=True)
	plano_comunicacao = models.TextField('Plano de comunicacao', blank=True)
