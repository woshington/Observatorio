...
urlpatterns = [
	...
	# MEMBRO EQUIPE
	path('membro/listar/', (MembroListar.as_view()), name='membro_equipe_listar'),
	path('membro/add/', (MembroCriar.as_view()), name='membro_equipe_add'),
	path('membro/editar/<int:pk>/', (MembroAtualizar.as_view()), name='membro_equipe_editar'),
	path('membro/<int:pk>/deletar/', (membro_deletar), name='membro_equipe_deletar'),
	path('membro/detalhar/<int:pk>/', (MembroDetalhar.as_view()), name='membro_equipe_detalhar'),
	path('membro/membro-equipe-autocomplete', (MembroAutocomplete.as_view()), name='membro_equipe_autocomplete'),    

	# PROJETO
	path('listar/', (ProjetoListar.as_view()), name='projeto_listar'),
	path('add/', (ProjetoCriar.as_view()), name='projeto_add'),
	path('add/<int:pk>/fase/', (ProjetoCriarFases.as_view()), name='projeto_add_fase'),
